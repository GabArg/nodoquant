                            ...
                            <tbody className="divide-y divide-white/5">
                                {strategies && strategies.length > 0 ? (
                                    strategies.map((strategy, index) => {
                                        ...
                                        let scoreTier = { label: "Weak Edge", color: "text-red-400", bg: "bg-red-500/10", border: "border-red-500/20" };
                                        if (score >= 90) scoreTier = { label: "Elite", color: "text-indigo-400", bg: "bg-indigo-500/15", border: "border-indigo-500/30" };
                                        else if (score >= 75) scoreTier = { label: "Strong Edge", color: "text-emerald-400", bg: "bg-emerald-500/10", border: "border-emerald-500/20" };
                                        else if (score >= 60) scoreTier = { label: "Moderate Edge", color: "text-amber-400", bg: "bg-amber-500/10", border: "border-amber-500/20" };
                                                ...
                                                <td className="px-6 py-6">
                                                    <div className="flex flex-col">
                                                        ...
                                                        <div className="flex items-center gap-2 mt-1">
                                                            ...
                                                            <span className="text-[9px] font-bold py-1 px-2 rounded-md bg-white/5 text-gray-500 uppercase tracking-tight leading-none">{strategy.market}</span>
                                                        </div>
                                                    </div>
                                                </td>
