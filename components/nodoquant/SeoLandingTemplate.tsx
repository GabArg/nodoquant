...
export default function SeoLandingTemplate({
    ...
    const t = useTranslations("seoTemplate");
    const finalCtaLabel = ctaLabel || t("defaultCta");
        ...
        <main className="min-h-screen pt-20 pb-24 px-4" style={{ background: "#07090F", color: "#f9fafb" }}>
            <div className="max-w-4xl mx-auto">
                ...
                <header className="text-center pt-16 pb-14">
                    ...
                    <p className="text-xs mt-3" style={{ color: "#4b5563" }}>{t("noCreditCard")}</p>
                </header>
                ...
                {/* ── Features ── */}
                <section className="mb-16">
                    <h2 className="text-2xl font-bold text-white text-center mb-8">{t("whatYouGet")}</h2>
                ...
                <div className="rounded-2xl px-8 py-12 text-center border"
                    ...
                    <h2 className="text-2xl font-extrabold text-white mb-3">{t("readyTitle")}</h2>
