...
export default function WhyItMatters() {
    ...
    const tCred = useTranslations("credibility");
    ...
    return (
        <section className="py-24 border-t border-white/[0.03] bg-[#050505]" id="why">
            <div className="container">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 items-stretch single-row-grid mb-24">
                    {[1, 2, 3].map((i) => (
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-10 text-center max-w-4xl mx-auto py-14 border-y border-white/[0.03]">
                    {[
                        { title: tCred("marketSupportTitle"), desc: tCred("marketSupportDesc") },
                        { title: tCred("dataImportsTitle"), desc: tCred("dataImportsDesc") },
                        { title: tCred("statsTitle"), desc: tCred("statsDesc") }
                    ].map((item, index) => (
