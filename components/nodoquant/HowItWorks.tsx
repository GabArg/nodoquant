...
export default function HowItWorks() {
    ...
    return (
        <section className="py-[120px] border-t border-white/[0.03] bg-black" id="process">
            <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div className="relative max-w-5xl mx-auto">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                        {[1, 2, 3].map((step) => (
                            <div key={step} className="p-10 bg-white/[0.02] border border-white/[0.05] rounded-[40px] group hover:bg-white/[0.04] hover:border-white/10 transition-all duration-500 relative overflow-hidden">
