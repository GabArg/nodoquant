            ...
            <div className="p-6">
                <div className="flex justify-between items-start mb-6">
                    ...
                    <div className={`w-14 h-14 rounded-2xl ${scoreBg} flex flex-col items-center justify-center border border-white/5 shadow-inner`}>
                        ...
                        <span className="text-[8px] font-bold uppercase text-gray-500/80">Score</span>
                    </div>
                </div>

                <div className="grid grid-cols-3 gap-2 py-4 border-y border-white/5">
                    <div className="text-center">
                        <p className="text-[10px] text-gray-500 font-bold uppercase tracking-tighter mb-1">Win Rate</p>
                        <p className="text-sm font-bold text-white tracking-tight">{wr.toFixed(1)}%</p>
                    </div>
                    <div className="text-center border-x border-white/5">
                        <p className="text-[10px] text-gray-500 font-bold uppercase tracking-tighter mb-1">Profit Factor</p>
                        <p className="text-sm font-bold text-white tracking-tight">{profit_factor.toFixed(2)}</p>
                    </div>
                    <div className="text-center">
                        <p className="text-[10px] text-gray-500 font-bold uppercase tracking-tighter mb-1">Trades</p>
